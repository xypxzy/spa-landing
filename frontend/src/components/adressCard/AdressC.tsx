        ...
        <section className={style.ad_card}>
            ...
            <div className={style.email}>
                <div className={style.svg}>
                    ...
                    <path d="M1 1.74255H23M1 1.74255V17.3259C1 17.569 1.09658 17.8022 1.26849 17.9741C1.44039 18.146 1.67355 18.2426 1.91667 18.2426H22.0833C22.3264 18.2426 22.5596 18.146 22.7315 17.9741C22.9034 17.8022 23 17.569 23 17.3259V1.74255M1 1.74255L9.2971 9.34823C10.8264 10.7501 13.1736 10.7501 14.7029 9.34823L23 1.74255" stroke="#292930" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
